    ...
    <div class="container pt-3">
        ...
        <div class="jumbotron jumbotron-fluid rounded py-sm-3 py-md-4 py-lg-5 mb-3">
            <div class="container text-center">
                <h1 class="display-4 text-ternary" style="font-size: 45px;">تسجيل الدخول</h1>
            </div>
        </div>

        <hr class="pb-1">

        <div class="jumbotron shadow py-4 text-muted">
            <form>
                <div class="form-group">
                    <input type="email" class="form-control" placeholder="البريد الإلكتروني">
                    <span class="small" style="font-size: small"></span>
                </div>
                    ...
                    <div class="custom-control custom-checkbox">
                        ...
                        <label class="custom-control-label" for="customControlInline">تذكرني</label>
                          ...
                          <a href="reset_password.php" style="color: #339aa5;">نسيت كلمة المرور؟</a>
                                ...
                                <!--production-->
<!--                <button type="submit" class="btn btn-block btn-ternary">دخول-->
