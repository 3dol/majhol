...
<style>
    ...
    <title>مجهول | تفيير كلمة المرور</title>
...
<div class="container pt-3">
    ...
    <div class="jumbotron jumbotron-fluid rounded py-sm-3 py-md-4 py-lg-5 mb-3">
        <div class="container text-center">
            <h1 class="display-4 text-ternary" style="font-size: 35px;">تغيير كلمة المرور</h1>
        </div>
    </div>
        ...
        <form>
            <div class="form-row">
                <div class="form-group col-md-12">
                    <input type="text" class="form-control" placeholder="كلمة المرور القديمة">
                </div>
            </div>
            ...
            <button type="submit" class="btn btn-block btn-ternary">تغيير
